...
\hhline{|-------|}
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{A fails}}
\\
\hhline{~~|-----|}
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{A doesn't fail}}
\\
\hhline{|-------|}
	 \multicolumn{2}{|c|}%
	{\setlength{\gnumericMultiRowLength}{0pt}%
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{B fails}}
\\
\hhline{~~|-----|}
	 \multicolumn{1}{|p{\gnumericColA}}%
	{}
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{B doesn't fail}}
\\
\hhline{|--|--|---|}
\end{tabular}
