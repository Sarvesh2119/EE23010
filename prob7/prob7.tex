...
\begin{align}
 X =
	\begin{cases}
		1, & \text{if the card is red}\\ 
		0, & \text{otherwise}
	\end{cases}
\end{align}
Hearts is a subset of red cards,hence $X$ covers it.
\begin{align}
Y =
	\begin{cases}
		1, & \text{if the card is king within a class}\\ 
		0, & \text{otherwise}
	\end{cases}
\end{align}
...
\begin{align}
&=1-p_{XY}\brak{00}\\
&=1-\brak{1-p_X\brak{1}}\brak{1-p_Y\brak{1}}\\
&=1-\brak{1-\frac{1}{2}}\brak{1-\frac{1}{13}}\\
&=1-\frac{6}{13}\\
&=\frac{7}{13}
\end{align}
\end{document}
