...
\solution
\begin{align}
E\brak{X|Y=y_0} &= \int_{-\infty}^{\infty}xf\brak{x|y}dx
\end{align}
where
\begin{align}
f\brak{x|y}=\frac{f\brak{x,y}}{f\brak{y}}
\end{align}
\begin{align}
f\brak{y}&=\int_{0}^{y}f\brak{x,y}dx\\
&=\int_{0}^{y}8xydx\\
&=8y\sbrak{\frac{x^2}{2}}_{0}^{y}\\
&=4y^3
\end{align}
Substituting f\brak{y} we get 
\begin{align}
f\brak{x|y}&=\frac{8xy}{4y^3}\\
&=\frac{2x}{y^2}
\end{align}
and 
\begin{align}
