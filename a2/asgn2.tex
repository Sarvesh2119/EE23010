...
\end{align}
$i$ and $j$ must be substituted corresponding to the sides including the angle.Then angle bisector of $A$ will be 
\begin{align}
       \myvec{\frac{\vec{n}_3^{\top}}{\norm{\vec{n}_3}} - \frac{\vec{n}_1^{\top}}{\norm{\vec{n}_1}}}\vec{x}
       =
       \frac{c_3}{\norm{\vec{n}_3}}-\frac{c_1}{\norm{\vec{n}_1}}
\end{align}
on substitution we obtain angle bisector of A as 
\begin{align}
\myvec{
...
\end{align}
Following similar process we obtain angle bisectors of $B$ and $C$ as 
\begin{align}
\myvec{
